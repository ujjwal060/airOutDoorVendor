...
const Change = () => {
  ...
  const verifyOtp = async () => {
    try {
      ...
      const response = await axios.post('http://44.196.64.110:8000/vendor/verifyOTP', { email, otp: otpString });
  ...
  const resendOtp = async () => {
    try {
      const response = await axios.post('http://44.196.64.110:8000/vendor/sendOTP', { email });
  ...
  const handlePasswordChange = async () => {
    try {
      const response = await axios.post('http://44.196.64.110:8000/vendor/forgate', { email, newPassword });
